...
public class Library extends Building{
   ...
   * @param nFloors number of floors libraray has
   * @param hasElevator confirms that library has elevator
   */
  ...
  /**
   * 
   * @param title title of book in the library's collection
   */
  ...
  public String removeTitle(String title){
    ...
    else{ // if the 'book' isn't in the collection
...
// Check out a book in 'this.collection'
  public void checkOut(String name){
    if(this.collection.contains(name)){ // checking if this is in the Library
      this.collection.get(name){ //gets the book from the Library
 ...
 * 
 * @param name name of library
 * @return name of book if it is in the library's collection
 */
